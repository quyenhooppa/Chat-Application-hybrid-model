...
public class requestGUI extends javax.swing.JFrame {
    ...
    public requestGUI(String name, int pos) {
        initComponents();
        jLabel1.setHorizontalAlignment(JTextField.CENTER);
        if (pos == 1){//when a user want to addfriend with other one
            jLabel1.setText("Send friend request to " + name + "?");
            //send request to other one
        }
        else {
            jLabel1.setText(name+" want to be your friend?");
            //handle action here
        }
    }
